                     ...
                     <div class="row">
                         <div class="item">
                             ...
                             <div class="content">
                                 ...
                                 <div class="stock mini-text" data-stock="{{ $product->stock_quantity }}">
                                    <div class="qty">
                                       <span>Sold: <strong class="qty-sold">9</strong></span>
                                       <span>Stock: <strong class="qty-available">{{ $product->stock_quantity }}</strong></span>
                                    </div>
                                    <div class="bar">
                                       <div class="available" style="background-color: #040e22"></div>
                                    </div>
                                 </div>
                                 <div class="offer">
                                     <p>Offer Ends At</p>
