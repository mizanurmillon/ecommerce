            ...
            <form action="{{ route('seo.update',$data->id) }}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $data->google_verification }}" name="google_verification">
                </div>
                <div class="form-group">
                  <label>Alexa Verification</label>
                  <input type="text" class="form-control" value="{{ $data->alexa_verification }}" name="alexa_verification">
